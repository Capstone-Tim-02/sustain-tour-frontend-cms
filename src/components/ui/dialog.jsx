...
const DialogContent = React.forwardRef(({ className, children, onClick, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
...
const DialogFooter = ({ className, children, ...props }) => (
  <>
    <div
      className={cn(
        'mt-6 flex flex-col-reverse gap-y-2 space-y-2 sm:flex-row sm:justify-end sm:space-x-2 sm:space-y-0',
        className
      )}
      {...props}
    >
