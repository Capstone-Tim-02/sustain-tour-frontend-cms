...
import { toggleFetchLatestAllTransaction } from '@/stores/features';
...
export const EditTransaction = ({ invoiceId }) => {
  ...
  useEffect(() => {
    async function fetchTransaction() {
      setIsLoading(true);
      setDetailTransaction(await APITransaction.getTransactionById(invoiceId));
      setIsLoading(false);
    }
  ...
  const onSubmit = async (data) => {
    try {
      setIsLoading(true);
      await APITransaction.updateTransaction(invoiceId, data);
